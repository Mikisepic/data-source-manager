				...
				<div class="collections-modal modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="heading-title">Create New Reference</h5>
						...
						<form role="form" @submit.prevent="saveReference">
							<div class="modal-body">
								...
								<div class="form-group has-label">
									...
									<br>
									<select name="" id="" v-model="form.category" class="form-control form-control mb-3">
								...
								<div class="form-group has-label">
									...
									<br>
									<select name="" id="" v-model="form.collection_id" class="form-control form-control mb-3">
										<option v-for="collection in collections" v-bind:key="collection.id" :value="collection.id">{{ collection.title }}</option>
									</select>
								</div>
								...
								<div class="mb-3 form-check">
									...
									/>
									<label class="form-check-label" for="hasPriceCheck">
										Has Price
									</label>
								</div>
...
<script>
	...
	export default {
		setup() {
			...
			return { form, errors, references, collections, saveReference, deleteReference };
		}
	};
</script>
